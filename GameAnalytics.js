(function(scope) {
    ...
    function(m) {
        ! function(e) {
            ...
            var n = (f.validateBusinessEvent = function(e, n, t, i, r) {
                ...
                return !!o.stringMatch(e, ^(unityunrealgamemakercocos2dconstructdefoldgodotflutter) [0-9]{0,5}(.[0-9]{0,5}){0,2}$)
            }, f.validateEngineVersion = function(e) {
                return !(!e  !o.stringMatch(e, ^(unityunrealgamemakercocos2dconstructdefoldgodot) [0-9]{0,5}(.[0-9]{0,5}){0,2}$))
                ...
                return o.stringMatch(e, ^(wwanwifilanoffline)$)
        ...
        ! function(e) {
            ...
            var t = (r.touch = function() {}, r.getRelevantSdkVersion = function() {
                ...
                var e, n = navigator.userAgent,
                    t = n.match((operachromesafarifirefoxubrowsermsietridentfbav(=))s(d+)i)  [];
                if (0 == t.length && ios === r.buildPlatform) return webkit_ + r.osVersion;
                if (tridenti.test(t[1])) return IE  + ((e = brv[ ]+(d+)g.exec(n)  [])[1]  );
                if (Chrome === t[1] && null != (e = n.match(b(OPREdgeUBrowser)(d+)))) return e.slice(1).join( ).replace(OPR, Opera).replace(UBrowser, UC).toLowerCase();
    ...
    function(e) {
        ...
        n = e.tasks  (e.tasks = {}), o = e.utilities.GAUtilities, d = e.logging.GALogger, l.execute = function(e, n, t, i) {
            ...
            if (l.timestampMap[n]  (l.timestampMap[n] = r), l.countMap[n]  (l.countMap[n] = 0), 3600 = (r.getTime() - l.timestampMap[n].getTime())  1e3 && (l.timestampMap[n] = r, l.countMap[n] = 0), !(l.countMap[n] = l.MaxCount)) {
                ...
                }, a.open(POST, e, !0), a.setRequestHeader(Content-Type, applicationjson), a.setRequestHeader(Authorization, s);
                try {
                    a.send(t)
                } catch (e) {
                    console.error(e)
    ...
    function(e) {
        ...
        function y() {
            this.protocol = fix.jshttps, this.hostName = api.gameanalytics.com, this.version = v2, this.remoteConfigsVersion = v1, this.baseUrl = this.protocol +  + this.hostName +  + this.version, this.remoteConfigsBaseUrl = this.protocol +  + this.hostName + remote_configs + this.remoteConfigsVersion, this.initializeUrlPath = init, this.eventsUrlPath = events, this.useGzip = !1
        }
        u = e.http  (e.http = {}), p = e.state.GAState, S = e.logging.GALogger, c = e.utilities.GAUtilities, h = e.validators.GAValidator, A = e.tasks.SdkErrorTask, v = e.events.EGASdkErrorCategory, g = e.events.EGASdkErrorArea, f = e.events.EGASdkErrorAction, m = e.events.EGASdkErrorParameter, y.prototype.requestInit = function(e, n) {
            ...
            if (a.onreadystatechange = function() {
                ...
                }, a.open(POST, e, !0), a.setRequestHeader(Content-Type, applicationjson), a.setRequestHeader(Authorization, d), i) throw new Error(gzip not supported);
            try {
                 a.send(n)
            } catch (e) {
